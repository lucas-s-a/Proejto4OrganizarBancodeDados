...
Após  e startar o servido do programa xampp e estiver rodando(running) abrir o Shell e inidcar o diretório onde irá ficar o arquivo Banco de dados SQL com nome nba_datb.sql
